...
1. How would you describe acessibility on the web to someone new to programming?
    ...
    Creating adaptable programs that are easy for users and the browsers to read on any device. 

2. Talk about 3 different things you can do to ensure your website is accessible. 

    ---using scalable units to size things
    ---filling in the alt attribute for images
    ---using semantic HTML

3. How would you explain the concept of a variable to someone new to programming?

    A variable is a unique placeholder that can store any value of data. There are 3 types of variables, var, let, and const.
    Var should be avoided because it can be reassigned and result in buggy code. Let and const are safer choices because they are only recognized within the block of code they are used. 

4. What is the purpose of using functions in code?

    Using functions makes it easier for code to be dry because they are reusable
